...
// // const a = new Hotel1('Resort Hotel', 5, 100);
// // console.log(hotel1);
...
// // Наприклад ми пишемо гру і нам необхідно підготувати логіку для системи персонажів, де є спільний конструктор Hero з дефолтними полями спільними для всіх класів, на кшталт імені, здоров'я, кількості досвіду тощо. Після чого нам необхідно зробити конструктори для Warrior та Wizard, екземпляри яких також повинні мати доступ до полів Hero, але водночас мати свої власні.
